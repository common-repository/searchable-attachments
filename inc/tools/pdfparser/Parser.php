...
include_once dirname( dirname( __FILE__ ) ) . '/tcpdf/tcpdf_parser.php';

$dir = dirname( __FILE__ ) . '/';

include_once $dir . 'Object.php';
include_once $dir . 'Font.php';
include_once $dir . 'Element.php';
include_once $dir . 'Element/ElementString.php';
foreach ( glob( "{$dir}*", GLOB_NOSORT | GLOB_MARK ) as $file ) {
